defmodule TimemanagerWeb.Router do
  ...
  pipeline :api do
    ...
    plug CORSPlug,
      origin: "*",
      headers: ~w(Accept Authorization Content-Type X-Requested-With X-HTTP-Method-Override),
  ...
  scope "/api", TimemanagerWeb do
    ...
    get "/workingtimes/search/:userid", WorkingtimeController, :showbydate
    get "/workingtimes/:userid/:id", WorkingtimeController, :showbyid
    options "/workingtimes/", WorkingtimeController, :create_workingtime
    options "/workingtimes/:id", WorkingtimeController, :update
